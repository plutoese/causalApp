      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute left-6 -translate-x-1 lg:-left-8 z-10 grid grid-flow-col auto-cols-max max-w-sm lg:-translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
